    ...
    private void checkAppVersion() {
        ...
        call.enqueue(new Callback<AppVersion>() {
            ...
            public void onResponse(Call<AppVersion> call, Response<AppVersion> response) {
                ...
                preferences.edit().putString("app_name", response.body().getApp()).apply();
                preferences.edit().putString("app_version", response.body().getVersion()).apply();
...
//                Toast.makeText(SplashActivity.this, "Gagal Koneksi Ke Server", Toast.LENGTH_SHORT).show();
                ...
                Snackbar.make(contextView, "Gagal Koneksi Ke Server", Snackbar.LENGTH_SHORT).show();
            }
        });
    }
}
